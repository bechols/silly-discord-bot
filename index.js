...
exports.handler = async function (event) {
  ...
  if (body && body.type === InteractionType.APPLICATION_COMMAND) {
    const gifs = [
      "https://i.gifer.com/9I2.gif", // Ketchup
      "https://media.giphy.com/media/nJPkKr231dvKo/giphy.gif", // High five
      "https://i.gifer.com/2AZI.gif", // Limo
      "https://i.imgur.com/6DpDNFS.gif", // Tuxedo
      "http://gph.is/1CF6Lgl", // We're in the Rockies
    ];
